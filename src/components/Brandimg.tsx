  ...
  return (
    <div >
       ...
       <img
          ...
          src={val.src}
          alt={val.text}
          className={`-z-10 rounded-xl   h-80 object-cover transition-opacity duration-1000 `}
        />
    </div>
      <div className=' w-80 absolute top-12 right-[30%] '>
        <figure className='mb-5'>
          <img src={val.logo} alt="" />
        </figure>
        <p className=' text-wrap text-white text-xl'>{val.text}</p>
